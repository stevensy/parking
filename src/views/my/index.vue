...
export default {
  ...
  watch: {
    ...
    openid(v) {
      ...
      this.nickname = v ? storage.get('userInfo') && storage.get('userInfo').nickname : undefined
    }
  },
  methods: {
    init() {
      this.backUrl = this.$router.mode === 'hash' ? 'http://m.hejnet.cn/#/my' : 'http://m.hejnet.cn/my'
